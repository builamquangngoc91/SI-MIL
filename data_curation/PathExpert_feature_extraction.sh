...
# Use pre-generated column name pickles from test_dataset
python club_features.py --feat_path "$parent_dir/features" --column_name_path "/Users/nam.le/Desktop/research/SI-MIL/test_dataset" --list_dict_path "$parent_dir/patches" --remove_cell_type "none"
